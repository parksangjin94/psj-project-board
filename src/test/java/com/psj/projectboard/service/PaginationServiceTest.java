...
class PaginationServiceTest {
    ...
    @MethodSource // 메소드 주입
    @ParameterizedTest // 값을 연속적으로 주입해 동일한 대상 메소드를 여러번 테스트 하면서 입출력값을 확인할 수 있다.
    void givenCurrentPageNumberAndTotalPages_whenCalculating_thenReturnsPaginationBarNumbers(int currentPageNumber, int totalPages, List<Integer> exoected){
        // Given
